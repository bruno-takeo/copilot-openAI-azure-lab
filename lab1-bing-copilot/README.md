# 🧪 Lab 1 – Explorando o Bing Chat e o Copilot
...
Todos os prompts utilizados neste laboratório estão disponíveis no arquivo [`prompts/bing-prompts.txt`](prompts/bing-prompts.txt).
